<script lang="ts">
    ...
    setInterval(() => {
        ...
        stats_vehicles_on_road = simulator.sim.stats.vehicle_on_road;
    }, 100);
</script>
    ...
    <div class="flex flex-col justify-around items-stretch m-4">
        ...
        >
            ...
            >
                ...
                <h2 class="font-semibold">Vehicle count</h2>
                <p
                    class="text-md"
                ...
                <p
                    class="text-md"
                    title="Number of vehicles that are currently on the road"
                >
                    &emsp; - on road: <span
                        class="font-semibold text-fuchsia-300"
                        title="Number of vehicles that are currently on the road"
                        >{stats_vehicles_on_road}</span
                    >
                </p>
